...
CLUSTER_MODEL_DIR="/gpfs/scratch/ehpc399/vincent/models/500k_arc"
PROPS_MODEL_DIR="/gpfs/scratch/ehpc399/vincent/models/PROPS_500k_arc_DoloresLike_20260309_163158"
...
"${PYTHON_BIN}" -m src.train_lightning1 \
  --predict \
  --data-test "${DATA_TEST}" \
  --name-output "eval_full_500k_arc.pkl" \
  ...
  --wandb-displayname "eval_full_500k_arc" \
  --num-workers 16 \
  --gpus 0 \
  --batch-size 1 \
  --start-lr 1e-3 \
