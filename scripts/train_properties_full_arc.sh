#!/bin/bash
#SBATCH --job-name=mlpf_props_500k_arc
...
MODEL_PREFIX="/gpfs/scratch/ehpc399/vincent/models/PROPS_500k_arc_DoloresLike_$(date +%Y%m%d_%H%M%S)/"
...
python -m src.train_lightning1 \
  ...
  --wandb-displayname "E_PID_arc_basicecor_v1_1_500k_4gpu" \
  --gpus 0,1,2,3 \
