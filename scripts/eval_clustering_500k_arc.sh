...
MODEL_DIR="/gpfs/scratch/ehpc399/vincent/models/arc_clustering_1M_2303"
...
for SPLIT in eCH neutral; do
  ...
  OUTPUT_NAME="eval_clustering_1M_arc_${SPLIT}.pkl"
  DISPLAY_NAME="eval_clustering_1M_arc_${SPLIT}"
  ...
  echo "Running ARC clustering eval for ${SPLIT} with ${#DATA_FILES[@]} files"
