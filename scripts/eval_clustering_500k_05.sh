#!/bin/bash
#SBATCH --job-name=mlpf_eval_clust_500k_05
...
MODEL_DIR="/gpfs/scratch/ehpc399/vincent/models/05_clustering_1M_2303"
...
for SPLIT in eCH neutral; do
  ...
  OUTPUT_NAME="eval_clustering_1M_05_${SPLIT}.pkl"
  DISPLAY_NAME="eval_clustering_1M_05_${SPLIT}"
